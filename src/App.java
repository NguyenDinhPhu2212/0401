		...
		try {
			...
			fadeOut.setOnFinished((e) -> {
				try {
					...
					homeHandler.show();
//					Station st = new Station(1, "EDO", "Ha Noi", 12, 13,14,40, null);
//					
//					StationScreenHandler stationScreenHandler = new StationScreenHandler(primaryStage, Configs.EDIT_STATION_PATH,st);
